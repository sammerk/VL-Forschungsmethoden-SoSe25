...
{{< iconify mdi:chart-bell-curve >}} Empirische Häufigkeitsverteilungen
...
[{{< iconify fa6-solid:crosshairs >}} Maße der zentralen Tendenz]{.em15 .c .imp}
...
[{{< iconify fa6-solid:arrows-alt-h >}} Maße der Streuung]{.em15 .c .imp}
...
## <!--Modalität--> {.center}
[{{< iconify fa6-solid:chart-area >}} Modalität]{.em15 .c .imp}
...
## <!--Schiefe--> {.center}
[{{< iconify fa6-solid:balance-scale-left >}} Schiefe]{.em15 .c .imp}
...
[{{< iconify fa6-solid:pencil >}} Einige grafische Darstellungen]{.em15 .c .imp}
